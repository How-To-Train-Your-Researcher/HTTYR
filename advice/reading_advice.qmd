...
One practical tip to build an impression is to **identify the authors and/or their affiliations**. Some institutions, or even specific labs within those institutions, prefer a more empirical approach as opposed to a theoretical one. Others focus on industry impacts over social ones --- for instance, improving token efficiency vs identifying demographic biases. Depending on the focus of your work, the title and the authors could sometimes provide enough information to proceed onto the next [pass](#pass-2-—-understanding-the-contribution). 
...
- [Writing Advice](writing_advice.qmd) — academic writing tips
