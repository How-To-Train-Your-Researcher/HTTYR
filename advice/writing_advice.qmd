...
| Pattern | Example |
|---|---|
| As Emphasis --- `A: B.` | "This paper explores one aspect of this trend: representational convergence." [@pmlr-v235-huh24a] |
...
In the category of dashes, there are Hyphens (-), En Dashes (--), and Em Dashes (---). These have their own specific use cases which can be found [here](https://www.merriam-webster.com/grammar/em-dash-en-dash-how-to-use).
...
At the end of the paragraph, we typically want to include some "claim" or statement. However, academic claims are rarely absolute. Hedging signals your confidence level
...
**Weak (three names for one concept):**
> "The PINN is trained to minimize the PDE residual. This **error** is evaluated at collocation points and added to the data loss. The **discrepancy** encourages the model to satisfy the governing equation."
...
**Revised (one name, consistently applied):**
> "The PINN minimises three losses: a PDE loss computed at collocation points, a data loss, and a boundary loss. The PDE loss penalises violations of the governing equation."
